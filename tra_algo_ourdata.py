...
def main():
    ...
    out_path = f'/data/yueli/cvpr2023_data_results/rsd/'
    ...
    for i in range(len(all_file)): 
        ...
        # import ipdb
        # ipdb.set_trace()
        transient_data = transient_data['data']  #sig final_meas measlr
        ...
        with torch.no_grad():
            ...
            # cv2.imwrite(out_path  + f'{i}_dep.png',depth_view)
            cv2.imwrite(out_path   + files[i] + '_int.png',front_view)
